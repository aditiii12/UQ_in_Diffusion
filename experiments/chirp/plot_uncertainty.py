"""
experiments/chirp/plot_uncertainty.py
--------------------------------------
Visualization for the chirp UQ experiment.

Loads results.pkl from run_uq.py and produces:
  - 3-panel trajectory plot colored by uncertainty
    (BayesDiff LLLA, FLARE LLLA, FLARE SubnetLaplace)
...
def get_args():
    ...
    p.add_argument("--results", type=str, default="assets/chirp/results.pkl")
...
# ---------------------------------------------------------------------------
# Core plotting function (shared with sines, could be moved to shared/)
# ---------------------------------------------------------------------------
...
def main():
    ...
    u_proj_subnet = res["u_proj_subnet"]
